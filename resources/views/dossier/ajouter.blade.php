                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="card card-default">
                                                <div class="card-header">
                                                    <h3 class="card-title">Les étapes</h3>
                                                </div>
                                                    ...
                                                    <div class="bs-stepper">
                                                        <div class="bs-stepper-header" role="tablist">
                                                            ...
                                                            <div class="step" data-target="#information-part">
                                                                <button type="button" class="step-trigger"
                                                                    role="tab" aria-controls="information-part"
                                                                    id="information-part-trigger">
                                                                    <span class="bs-stepper-circle">2</span>
                                                                    <span class="bs-stepper-label">Expérience</span>
                                                                </button>
                                                            </div>
                                                            <div class="line"></div>
                                                            <div class="step" data-target="#information-parts">
                                                                <button type="button" class="step-trigger"
                                                                    role="tab" aria-controls="information-parts"
                                                                    id="information-part-triggers">
                                                                    <span class="bs-stepper-circle">3</span>
                                                                    <span class="bs-stepper-label">Compétences</span>
                                                                </button>
                                                            </div>
                                                            <div class="line"></div>
                                                            <div class="step" data-target="#document-part">
                                                                <button type="button" class="step-trigger"
                                                                    role="tab" aria-controls="document-part"
                                                        ...
                                                        <div class="bs-stepper-content">
                                                            ...
                                                            <div id="logins-part" class="content" role="tabpanel"
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="exampleInputEmail1">Adresse
                                                                        Email</label>
                                                            ...
                                                            <div id="information-part" class="content"
                                                                role="tabpanel"
                                                                aria-labelledby="information-part-trigger">

                                                                <div class="form-group">
                                                                    <label for="Prenom">Niveau d'etude</label>
                                                                    <input type="text" class="form-control"
                                                                        id="prenom" name="prenom"
                                                                        placeholder="Entrer prénom">
                                                                </div>
                                                            ...
                                                            <div id="information-parts" class="content"
                                                                role="tabpanel"
                                                                aria-labelledby="information-part-triggers">
